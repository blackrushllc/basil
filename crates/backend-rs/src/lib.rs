...
fn render_main_rs(src_path: &Path, module: &Module) -> String {
    ...
    render_instrs(&module.main.body, &mut vars, &mut body, 0);
...
fn render_instrs(instrs: &Vec<Instr>, vars: &mut HashMap<String, String>, out: &mut String, mut indent: usize) {
    ...
    for ins in instrs {
        match ins {
            ...
            Instr::For { var, start, end, step, body } => {
                ...
                render_instrs(body, vars, out, indent);
                // restore
